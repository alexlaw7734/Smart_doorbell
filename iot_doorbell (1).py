...
#ACCESS_KEY = 'AKIAIZF2FI6B6X7VECXA'
#SECRET_KEY = '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'
...
def mask_image(img):
    ...
    #pts=np.array([[553,707],[700,650],[843,550],[833,124],[1100,109],[1100,609],[906,700]],dtype=np.int32)
...
while True:
	...
	if detector_total>10000:
		...
		#send text message
		#account_sid="ACa2f1b0beeea73f273f2334cfb538fa20"
		#auth_token="9503e98fe97189e3289dc40ed1561613"
